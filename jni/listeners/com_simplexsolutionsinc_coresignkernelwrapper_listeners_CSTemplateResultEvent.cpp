/*
 * com_simplexsolutionsinc_coresignkernelwrapper_listeners_CSTemplateResultEvent.cpp
 *
 *  Created on: 20 мая 2015
 *      Author: gleb
 */

#include "com_simplexsolutionsinc_coresignkernelwrapper_listeners_CSTemplateResultEvent.h"
		...
		JNIEnv *env, jobject event)
{
	...
	CS::TemplateResultEvent *nativeEvent = reinterpret_cast<CS::TemplateResultEvent*>(lptr);
